...
if command_exists brew; then
  ...
  alias bupc='brew bundle check -v || brew bundle install -q || true; brew bundle cleanup -f || true; brew cleanup --prune=all || true; brew autoremove || true; brew upgrade || true;'
fi
