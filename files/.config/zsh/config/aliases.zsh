...
if command_exists colima; then
  alias clst='colima start -c 6 -m 8 && echo "Please approve for creating softlink to /var/run/docker.sock" && sudo ln -sf ${HOME}/.config/colima/default/docker.sock /var/run/docker.sock'
